...
exports.myDemandChats = async (req, res) => {
    ...
    try {
        ...
        const demandschat = await demandModel.find({ _id: uniqueDemandIds }).select("userId shape category size clarity color Cut imageUrl1 imageUrl2 imageUrl3 updatedAt")
