...
const {getUsers,getFeedbacks,deleteDocument, getReports, getDocuments, changePassword, updateVerificationStatus, addAdvertisement, showAds, updateReportStatus, updateFeedbackStatus, deleteAd, deleteWholeAdvertisement, } =require("../AdminControllers/user");
